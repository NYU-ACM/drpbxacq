...
create table "TRANSFERS" ("ID" UUID NOT NULL PRIMARY KEY,"USER_ID" BIGINT NOT NULL,"TITLE" VARCHAR(254) NOT NULL,"XFER_DATE" DATE NOT NULL,"STATUS" INTEGER NOT NULL,"CANCEL_NOTE" VARCHAR(254) NOT NULL);
