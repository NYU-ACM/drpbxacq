...
create table "TRANSFERS" ("ID" UUID NOT NULL PRIMARY KEY,"USER_ID" BIGINT NOT NULL,"TITLE" VARCHAR(254) NOT NULL,"XFER_DATE" DATE NOT NULL,"STATUS" INTEGER NOT NULL,"ACCESSION_ID" VARCHAR(254) NOT NULL,"ADMIN_NOTE" VARCHAR(254) NOT NULL,"DONOR_NOTE" VARCHAR(254) NOT NULL);
